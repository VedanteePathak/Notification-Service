...
import org.adrij.common.Exceptions.RedisCustomException;
...
import org.adrij.consumer.Services.KafkaConsumerServiceAdapter;
import org.adrij.consumer.Services.ThirdPartyAPIServiceAdapter;
import static org.adrij.consumer.Constants.KafkaConsumerConstants.CONSUMER_GROUP_ID;
import static org.adrij.consumer.Constants.KafkaConsumerConstants.CONSUMER_KAFKA_TOPIC_NAME;
...
public class KafkaConsumerService implements KafkaConsumerServiceAdapter {
    ...
    @KafkaListener(topics = CONSUMER_KAFKA_TOPIC_NAME, groupId = CONSUMER_GROUP_ID)
