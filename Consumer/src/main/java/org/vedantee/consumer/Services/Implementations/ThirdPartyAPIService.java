...
import org.vedantee.consumer.Services.Implementations.ThirdPartyAPISupports.Channels;
import org.vedantee.consumer.Services.Implementations.ThirdPartyAPISupports.Destination;
import org.vedantee.consumer.Services.Implementations.ThirdPartyAPISupports.SMS;
import org.vedantee.consumer.Services.Implementations.ThirdPartyAPISupports.SMSBody;
...
public class ThirdPartyAPIService implements ThirdPartyAPIServiceAdapter {
    ...
    public void sendSMSOkHttp(String phoneNumber, long requestId, String smsText) {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url(ThirdPartyAPIConstants.THIRD_PARTY_API_URL)
                    .post(requestBody)
                    .addHeader("accept", "application/json")
                    .addHeader("Content-Type", "application/json")
                    .addHeader("Key", ThirdPartyAPIConstants.THIRD_PARTY_API_KEY)
                    .build();
    ...
    public void sendSMSRestTemplate(String phoneNumber, long requestId, String smsText) {
        ...
        try {
            ...
            headers.setBasicAuth(ThirdPartyAPIConstants.THIRD_PARTY_API_KEY);
            ...
            ResponseEntity<String> responseEntity =
                    restTemplate.exchange(
                            ThirdPartyAPIConstants.THIRD_PARTY_API_URL,
                            HttpMethod.POST,
                            requestEntity,
                            String.class
                    );
